...
import { stripUrlQueryAndFragment, getBreadcrumbLogLevelFromHttpStatusCode, parseUrl, getSanitizedUrlString, logger } from '@sentry/utils';
 ...
 */
function patchRequestToCaptureBody(req, normalizedRequest) {
  const chunks = [];
